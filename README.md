...
To start the automation watchdog processes in case they are down, do  
```
...
cd ~/oncomine_auto
# Run Myelo
nohup ./run_myelo_prd.sh &
# Run Oncomine
nohup ./run_oncomine_prd.sh &
...
python3 ion_runner.py ~/oncomine_auto/ion_config_IR2.conf /mnt/Z_drive/Molecular/IonTorrent/oncomine/IR2.dropoff/<runid>.xlsm
```
__Myeloseqer__  
```
# log in to the production VM
...
# if the run is on IR2
python3 myelo_runner.py ~/oncomine_auto/ion_config_IR2.conf /mnt/Z_drive/Molecular/IonTorrent/myeloseqer/IR2.dropoff/<runid>.xlsm
```
