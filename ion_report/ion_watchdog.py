    ...
    def on_any_event(self, event):
        ...
        if event.event_type == "created":
            ...
            send_email_notification(
                subject="Oncomine watchdog: file detected",
                body=(
            ...
            try:
                ...
                send_email_notification(
                    subject="Oncomine watchdog: run finished successfully",
                    body=(
                        f"Oncomine run completed successfully.\n\n"
                ...
                send_email_notification(
                    subject="Oncomine watchdog: run failed",
                    body=(
                        f"Oncomine run failed with an error.\n\n"
                        f"Time: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n"
                        f"File: {event.src_path}\n"
                        f"Error: {e}\n"
                    ),
